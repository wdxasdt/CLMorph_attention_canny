...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--epoch_count', type=int, default=117, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
        ...
        self.parser.add_argument('--num_classes', type=int, default=5, help='lpba40')
