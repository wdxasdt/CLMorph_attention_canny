...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', required=True, default='datasets/LPBA40/LPBA40_rigidly_registered_pairs_histogram_standardization_small',help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        self.parser.add_argument('--cannyroot', required=True,default='datasets/LPBA40/canny',help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        self.parser.add_argument('--batchSize', type=int, default=1, help='input batch size')
        self.parser.add_argument('--gpu_ids', type=str, default='1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--name', type=str, default='experiment_name', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--dataset_mode', type=str, default='lpba40_contrastive_learning', help='chooses how datasets are loaded. [lpba40 | mindboogle101]')
